...
def show_czsc(name: str, contract, levels: [QuoteLevel], count: int):

    quotes = get_quotes(contract, datetime.now(), count, levels[0])
...
if __name__ == '__main__':
    show_czsc('IH8888-30m.html','IH8888', [FIVE_MINUTE,THIRTY_MINUTE,ONE_DAY], 50000)
